...
AND i.uid=u.uid AND u.uid=b.uid AND i.pid=sp.pid AND sp.pid=b.pid AND i.sid=s.sid AND s.sid=b.sid AND b.invoice=2 GROUP BY b.date";
...
<head>
	...
	<link href="../partner/css/invoice.css" rel="stylesheet">
</head>
<body>
			...
			<h4 style="text-align:center">INVOICE </h4>
                <div class="row">
                    ...
                    <div class="col company-details">
                        ...
                        <div>9624980803</div>
                        <div class="email"><a href="mailto:amul4577@gmail.com">amul4577@gmail.com</a></div>
                    </div>
                </div>
            </header>
            <main>
